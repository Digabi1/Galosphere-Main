...
public class SpectreFlareEntityRenderer extends EntityRenderer<SpectreFlare> {
    private final ItemRenderer itemRenderer;

    public SpectreFlareEntityRenderer(EntityRendererProvider.Context ctx) {
        super(ctx);
    ...
    public void render(SpectreFlare entity, float p_114657_, float p_114658_, PoseStack poseStack, MultiBufferSource source, int p_114661_) {
        ...
        this.itemRenderer.renderStatic(new ItemStack(GItems.SPECTRE_FLARE), ItemTransforms.TransformType.GROUND, 15728880, OverlayTexture.NO_OVERLAY, poseStack, source, entity.getId());
        poseStack.popPose();
