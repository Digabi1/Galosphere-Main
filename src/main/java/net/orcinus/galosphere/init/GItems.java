...
public class GItems {
    ...
    public static void init() {
        GItems.ITEMS.forEach((resourceLocation, item) -> Registry.register(BuiltInRegistries.ITEM, resourceLocation, item));
        GBlocks.BLOCK_ITEMS.forEach((resourceLocation, item) -> Registry.register(BuiltInRegistries.ITEM, resourceLocation, item));
    }
